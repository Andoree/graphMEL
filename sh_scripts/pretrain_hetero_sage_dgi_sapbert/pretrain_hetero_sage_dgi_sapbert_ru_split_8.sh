...
#SBATCH --error=../../logs/pretrain_heterosage_dgi_sapbert_ru_split/ru_pretrain_heterosage_dgi_sapbert_8.err        # Файл для вывода ошибок
#SBATCH --output=../../logs/pretrain_heterosage_dgi_sapbert_ru_split/ru_pretrain_heterosage_dgi_sapbert_8.txt       # Файл для вывода результатов
