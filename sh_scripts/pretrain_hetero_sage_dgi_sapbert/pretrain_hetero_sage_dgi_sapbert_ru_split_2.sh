...
#SBATCH --error=../../logs/pretrain_heterosage_dgi_sapbert_ru_split/ru_pretrain_heterosage_dgi_sapbert_2.err        # Файл для вывода ошибок
#SBATCH --output=../../logs/pretrain_heterosage_dgi_sapbert_ru_split/ru_pretrain_heterosage_dgi_sapbert_2.txt       # Файл для вывода результатов
