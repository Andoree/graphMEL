...
#SBATCH --error=../../logs/fair_evaluation/fair_eval_SPA_mbert_rgcn_dgi.err        # Файл для вывода ошибок
#SBATCH --output=../../logs/fair_evaluation/fair_eval_SPA_mbert_rgcn_dgi.txt       # Файл для вывода результатов
#SBATCH --time=20:30:00                      # Максимальное время выполнения
#SBATCH --cpus-per-task=3                   # Количество CPU на одну задачу
#SBATCH --gpus=1

export CUDA_VISIBLE_DEVICES=0
MODEL = "/home/etutubalina/classification_transfer_learning/graphmel/pretrained_graph_sapbert_encoders/2020AB/RGCN_DGI_SapBERT/SPA_full_mbert/dgi_0.001_rgcn_[5]_768--None-96_rellr_2e-05_b_128_rgcn_conv/checkpoint_e_1_steps_17370.pth"
