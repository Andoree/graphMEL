...
#SBATCH --error=../../logs/fair_evaluation/fair_eval_baseline_sapbert_rgcn_dgi.err        # Файл для вывода ошибок
#SBATCH --output=../../logs/fair_evaluation/fair_eval_baseline_sapbert_rgcn_dgi.txt       # Файл для вывода результатов
