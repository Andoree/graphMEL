...
#SBATCH --error=../../logs/fair_evaluation/fair_eval_baseline_coder_rgcn_dgi.err        # Файл для вывода ошибок
#SBATCH --output=../../logs/fair_evaluation/fair_eval_baseline_coder_rgcn_dgi.txt       # Файл для вывода результатов
#SBATCH --time=20:30:00                      # Максимальное время выполнения
#SBATCH --cpus-per-task=3                   # Количество CPU на одну задачу
#SBATCH --gpus=1

export CUDA_VISIBLE_DEVICES=0
MODEL = "/home/etutubalina/classification_transfer_learning/graphmel/models/GanjinZero/coder_all"
