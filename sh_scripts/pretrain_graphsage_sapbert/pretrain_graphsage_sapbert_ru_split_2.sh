...
#SBATCH --error=../../logs/pretrain_graphsage_sapbert_ru_split/ru_pretrain_graphsage_sapbert_2.err        # Файл для вывода ошибок
#SBATCH --output=../../logs/pretrain_graphsage_sapbert_ru_split/ru_pretrain_graphsage_sapbert_2.txt       # Файл для вывода результатов
...
nvidia-smi
python ../../scripts/self_alignment_pretraining/train_graphsage_sapbert.py --train_dir="../../data/umls_graph/2020AB_pos_pairs_datasets/RUS_pos_pairs_russian_FULL" \
