...
#SBATCH --error=../../logs/pretrain_graphsage/ru_pretrain_graphsage_3.err        # Файл для вывода ошибок
#SBATCH --output=../../logs/pretrain_graphsage/ru_pretrain_graphsage_3.txt       # Файл для вывода результатов
