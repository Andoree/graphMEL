...
#SBATCH --error=../../logs/pretrain_graphsage/ru_pretrain_graphsage_2.err        # Файл для вывода ошибок
#SBATCH --output=../../logs/pretrain_graphsage/ru_pretrain_graphsage_2.txt       # Файл для вывода результатов
