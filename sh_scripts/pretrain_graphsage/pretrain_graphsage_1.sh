...
#SBATCH --error=../../logs/pretrain_graphsage/ru_pretrain_graphsage_1.err        # Файл для вывода ошибок
#SBATCH --output=../../logs/pretrain_graphsage/ru_pretrain_graphsage_1.txt       # Файл для вывода результатов
