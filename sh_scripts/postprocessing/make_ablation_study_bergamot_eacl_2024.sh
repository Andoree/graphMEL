...
#SBATCH --error=/home/etutubalina/graph_entity_linking/graphmel/logs/postprocessing/make_ablation_study_bergamot_eacl_2024.err        # Файл для вывода ошибок
#SBATCH --output=/home/etutubalina/graph_entity_linking/graphmel/logs/postprocessing/make_ablation_study_bergamot_eacl_2024.txt       # Файл для вывода результатов
#SBATCH --time=05:50:00                      # Максимальное время выполнения
#SBATCH --cpus-per-task=1                   # Количество CPU на одну задачу


python /home/etutubalina/graph_entity_linking/graphmel/graphmel/scripts/postprocessing/make_ablation_study.py \
