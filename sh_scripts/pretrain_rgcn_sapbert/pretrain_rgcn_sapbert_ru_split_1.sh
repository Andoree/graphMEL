...
#SBATCH --error=../../logs/pretrain_rgcn_sapbert_ru_split/ru_pretrain_rgcn_sapbert_1.err        # Файл для вывода ошибок
#SBATCH --output=../../logs/pretrain_rgcn_sapbert_ru_split/ru_pretrain_rgcn_sapbert_1.txt       # Файл для вывода результатов
