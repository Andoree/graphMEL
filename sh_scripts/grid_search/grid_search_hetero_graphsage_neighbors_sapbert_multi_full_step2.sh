...
#SBATCH --error=../../logs/grid_search/grid_search_multi_full_hetero_graphsage_neighbors_sapbert_step2.err        # Файл для вывода ошибок
#SBATCH --output=../../logs/grid_search/grid_search_multi_full_hetero_graphsage_neighbors_sapbert_step2.txt       # Файл для вывода результатов
...
python ../../scripts/grid_search/hetero_graphsage_neighbors_sapbert_grid_search.py --train_dir="../../data/umls_graph/2020AB_pos_pairs_datasets/ENG_FRE_GER_SPA_DUT_RUS_pos_pairs_multilingual_FULL" \
...
--output_dir="../../grid_search/2020AB/HeteroSAGE_neighbors/gs_MULTI_FULL_step2"
