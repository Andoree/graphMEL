...
#SBATCH --error=../../logs/grid_search/grid_search_multi_full_hetero_graphsage_dgi_sapbert.err        # Файл для вывода ошибок
#SBATCH --output=../../logs/grid_search/grid_search_multi_full_hetero_graphsage_dgi_sapbert.txt       # Файл для вывода результатов
...
--output_dir="../../grid_search/2020AB/HeteroSAGE_DGI/gs_MULTI_FULL"
