...
#SBATCH --error=../logs/pretrain_graph_model_3.err        # Файл для вывода ошибок
#SBATCH --output=../logs/pretrain_graph_model_3.txt       # Файл для вывода результатов
...
--gpus=4 \
--output_dir="../pretrained_models/2020AB/RU_split_v3"
