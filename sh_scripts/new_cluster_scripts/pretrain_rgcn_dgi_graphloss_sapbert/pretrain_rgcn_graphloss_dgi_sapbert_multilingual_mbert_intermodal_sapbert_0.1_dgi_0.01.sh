...
#SBATCH --error=/home/echernyak/graph_entity_linking/graphmel/logs/pretrain_rgcn_dgi_multilingual_full/mbert_dgi_graph_loss_multilingual_pretrain_rgcn_mbert_article_1_layer_sapbert_0.1_dgi_0.01.err        # Файл для вывода ошибок
#SBATCH --output=/home/echernyak/graph_entity_linking/graphmel/logs/pretrain_rgcn_dgi_multilingual_full/mbert_dgi_graph_loss_multilingual_pretrain_rgcn_mbert_article_1_layer_sapbert_0.1_dgi_0.01.txt       # Файл для вывода результатов
