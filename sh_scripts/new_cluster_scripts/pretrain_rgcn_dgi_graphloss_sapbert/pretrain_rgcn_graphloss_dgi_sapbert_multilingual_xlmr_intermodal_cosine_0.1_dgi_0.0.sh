...
#SBATCH --error=/home/etutubalina/graph_entity_linking/graphmel/logs/pretrain_rgcn_dgi_multilingual_full/xlmr_dgi_graph_loss_multilingual_pretrain_rgcn_xlmr_article_1_layer_cosine_0.1_dgi_0.0.err        # Файл для вывода ошибок
#SBATCH --output=/home/etutubalina/graph_entity_linking/graphmel/logs/pretrain_rgcn_dgi_multilingual_full/xlmr_dgi_graph_loss_multilingual_pretrain_rgcn_xlmr_article_1_layer_cosine_0.1_dgi_0.0.txt       # Файл для вывода результатов
