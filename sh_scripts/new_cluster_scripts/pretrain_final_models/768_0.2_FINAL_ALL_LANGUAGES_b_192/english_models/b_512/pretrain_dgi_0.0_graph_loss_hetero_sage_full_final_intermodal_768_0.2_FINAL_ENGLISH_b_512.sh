...
#SBATCH --error=/home/etutubalina/graph_entity_linking/graphmel/logs/pretrain_heterosage_graphloss_dgi_multilingual_full/pretrain_dgi_0.0_graph_loss_hetero_sage_full_final_intermodal_768_0.2_FINAL_ENGLISH_b_512.err         # Файл для вывода ошибок
#SBATCH --output=/home/etutubalina/graph_entity_linking/graphmel/logs/pretrain_heterosage_graphloss_dgi_multilingual_full/pretrain_dgi_0.0_graph_loss_hetero_sage_full_final_intermodal_768_0.2_FINAL_ENGLISH_b_512.txt       # Файл для вывода результатов
