...
#SBATCH --error=/home/etutubalina/graph_entity_linking/graphmel/logs/pretrain_graph_models_final/pretrain_dgi_0.0_graph_loss_RGCN_full_final_sapbert_intermodal_768_0.2_FINAL_ENGLISH_b_192.err        # Файл для вывода ошибок
#SBATCH --output=/home/etutubalina/graph_entity_linking/graphmel/logs/pretrain_graph_models_final/pretrain_dgi_0.0_graph_loss_RGCN_full_final_sapbert_intermodal_768_0.2_FINAL_ENGLISH_b_192.txt       # Файл для вывода результатов
