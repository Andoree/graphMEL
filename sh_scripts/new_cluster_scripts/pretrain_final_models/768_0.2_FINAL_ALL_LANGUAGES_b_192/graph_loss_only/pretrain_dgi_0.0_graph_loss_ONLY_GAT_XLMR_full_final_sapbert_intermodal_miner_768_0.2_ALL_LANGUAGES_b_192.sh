...
#SBATCH --error=/home/etutubalina/graph_entity_linking/graphmel/logs/pretrain_graph_models_final/pretrain_dgi_0.0_graph_loss_ONLY_GAT_XLMR_full_final_sapbert_intermodal_miner_768_0.2_ALL_LANGUAGES_b_192.err        # Файл для вывода ошибок
#SBATCH --output=/home/etutubalina/graph_entity_linking/graphmel/logs/pretrain_graph_models_final/pretrain_dgi_0.0_graph_loss_ONLY_GAT_XLMR_full_final_sapbert_intermodal_miner_768_0.2_ALL_LANGUAGES_b_192.txt       # Файл для вывода результатов
...
--output_dir="/home/etutubalina/graph_entity_linking/results/pretrained_graphsapbert/2020AB/768_0.2_FINAL_MONOLINGUAL_b_192/XLMR_GAT_DGI_0.0_GRAPH_LOSS_ONLY_ALL_LANGUAGES"
