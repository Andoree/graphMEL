...
#SBATCH --error=/home/etutubalina/graph_entity_linking/graphmel/logs/pretrain_graph_models_final/pretrain_NO_NEIGHBORS_MS_dgi_0.01_graph_loss_GAT_XLMR_full_sapbert_intermodal_miner_768_0.2_NEIGHBORS_MS_LOSS.err        # Файл для вывода ошибок
#SBATCH --output=/home/etutubalina/graph_entity_linking/graphmel/logs/pretrain_graph_models_final/pretrain_NO_NEIGHBORS_MS_dgi_0.01_graph_loss_GAT_XLMR_full_sapbert_intermodal_miner_768_0.2_NEIGHBORS_MS_LOSS.txt       # Файл для вывода результатов
...
--output_dir="/home/etutubalina/graph_entity_linking/results/pretrained_graphsapbert/2020AB/768_0.2_FINAL_NEIGHBORS_MS_LOSS_ALL_LANGUAGES/GAT_DGI_XLMR_NO_NEIGHBORS_MS"
