...
#SBATCH --error=/home/etutubalina/graph_entity_linking/graphmel/logs/pretrain_graph_models_final/GRAPHSAGE_BERGAMOT_GRANT_2023_RUSSIAN_DGI_0.0.err        # Файл для вывода ошибок
#SBATCH --output=/home/etutubalina/graph_entity_linking/graphmel/logs/pretrain_graph_models_final/GRAPHSAGE_BERGAMOT_GRANT_2023_RUSSIAN_DGI_0.0.txt       # Файл для вывода результатов
#SBATCH --time=15:59:59                      # Максимальное время выполнения
...
--output_dir="/home/etutubalina/graph_entity_linking/results/pretrained_graphsapbert/2020AB/768_0.2_FINAL_NEIGHBORS_MS_LOSS_RUS_GRANT_2023/GRAPHSAGE_DGI_RUS/"
