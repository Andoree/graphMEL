...
#SBATCH --error=/home/etutubalina/graph_entity_linking/graphmel/logs/pretrain_graph_models_final/pretrain_dgi_0.1_graph_1.0_GRAPHSAGE_xlmr_all_INT_MINER_768_0.2_FINAL_NO_N_MS_b256_mapped_eng_20_20_20_src.err        # Файл для вывода ошибок
#SBATCH --output=/home/etutubalina/graph_entity_linking/graphmel/logs/pretrain_graph_models_final/pretrain_dgi_0.1_graph_1.0_GRAPHSAGE_xlmr_all_INT_MINER_768_0.2_FINAL_NO_N_MS_b256_mapped_eng_20_20_20_src.txt       # Файл для вывода результатов
