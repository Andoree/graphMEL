...
#SBATCH --error=/home/etutubalina/graph_entity_linking/graphmel/logs/pretrain_graph_models_final/pretrain_dgi_0.01_graph_loss_GAT_monolingual_SAPBERT_CKPT_full_sapbert_intermodal_miner_768_0.2_monolingual_NO_N_MS.err        # Файл для вывода ошибок
#SBATCH --output=/home/etutubalina/graph_entity_linking/graphmel/logs/pretrain_graph_models_final/pretrain_dgi_0.01_graph_loss_GAT_monolingual_SAPBERT_CKPT_full_sapbert_intermodal_miner_768_0.2_monolingual_NO_N_MS.txt       # Файл для вывода результатов
...
--output_dir="/home/etutubalina/graph_entity_linking/results/pretrained_graphsapbert/2020AB/768_0.2_monolingual_NO_N_MS/GAT_DGI_SPA_SAPBERT_CKPT"
...
--agg_mode "cls" \
--save_every_N_epoch=1 \
--output_dir="/home/etutubalina/graph_entity_linking/results/pretrained_graphsapbert/2020AB/768_0.2_monolingual_NO_N_MS/GAT_DGI_DUT_SAPBERT_CKPT"
...
--agg_mode "cls" \
--save_every_N_epoch=1 \
--output_dir="/home/etutubalina/graph_entity_linking/results/pretrained_graphsapbert/2020AB/768_0.2_monolingual_NO_N_MS/GAT_DGI_FRE_SAPBERT_CKPT"
...
--agg_mode "cls" \
--save_every_N_epoch=1 \
--output_dir="/home/etutubalina/graph_entity_linking/results/pretrained_graphsapbert/2020AB/768_0.2_monolingual_NO_N_MS/GAT_DGI_GER_SAPBERT_CKPT"
