...
#SBATCH --error=/home/etutubalina/graph_entity_linking/graphmel/logs/pretrain_graph_models_final/pretrain_dgi_0.0_graph_loss_RGCN_ENGLISH_full_sapbert_intermodal_miner_768_0.2_NEIGHBORS_MS_LOSS.err        # Файл для вывода ошибок
#SBATCH --output=/home/etutubalina/graph_entity_linking/graphmel/logs/pretrain_graph_models_final/pretrain_dgi_0.0_graph_loss_RGCN_ENGLISH_full_sapbert_intermodal_miner_768_0.2_NEIGHBORS_MS_LOSS.txt       # Файл для вывода результатов
