...
#SBATCH --error=/home/etutubalina/graph_entity_linking/graphmel/logs/pretrain_graph_models_final/pretrain_dgi_0.0_graph_loss_GAT_ENGLISH_full_sapbert_intermodal_miner_768_0.2_NO_N_MS_NOREL_common_hard_pairs_NOLOOPS.err        # Файл для вывода ошибок
#SBATCH --output=/home/etutubalina/graph_entity_linking/graphmel/logs/pretrain_graph_models_final/pretrain_dgi_0.0_graph_loss_GAT_ENGLISH_full_sapbert_intermodal_miner_768_0.2_NO_N_MS_NOREL_common_hard_pairs_NOLOOPS.txt       # Файл для вывода результатов
...
--output_dir="/home/etutubalina/graph_entity_linking/results/pretrained_graphsapbert/2020AB/768_0.2_ENGLISH/GAT_DGI_MULTILINGUAL"
