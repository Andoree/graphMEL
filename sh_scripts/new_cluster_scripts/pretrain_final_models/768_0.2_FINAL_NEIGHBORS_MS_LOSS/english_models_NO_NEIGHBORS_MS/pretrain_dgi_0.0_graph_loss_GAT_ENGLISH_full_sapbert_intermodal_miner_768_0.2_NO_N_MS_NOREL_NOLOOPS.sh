...
#SBATCH --error=/home/etutubalina/graph_entity_linking/graphmel/logs/pretrain_graph_models_final/pretrain_dgi_0.0_graph_loss_GAT_ENGLISH_full_sapbert_intermodal_miner_768_0.2_NO_N_MS_NOREL_NOLOOPS.err        # Файл для вывода ошибок
#SBATCH --output=/home/etutubalina/graph_entity_linking/graphmel/logs/pretrain_graph_models_final/pretrain_dgi_0.0_graph_loss_GAT_ENGLISH_full_sapbert_intermodal_miner_768_0.2_NO_N_MS_NOREL_NOLOOPS.txt       # Файл для вывода результатов
