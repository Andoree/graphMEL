...
#SBATCH --error=/home/etutubalina/graph_entity_linking/graphmel/logs/pretrain_graph_models_final/pretrain_dgi_0.01_graph_loss_GRAPHSAGE_ENGLISH_full_sapbert_intermodal_miner_768_0.2_NO_N_MS.err        # Файл для вывода ошибок
#SBATCH --output=/home/etutubalina/graph_entity_linking/graphmel/logs/pretrain_graph_models_final/pretrain_dgi_0.01_graph_loss_GRAPHSAGE_ENGLISH_full_sapbert_intermodal_miner_768_0.2_NO_N_MS.txt       # Файл для вывода результатов
