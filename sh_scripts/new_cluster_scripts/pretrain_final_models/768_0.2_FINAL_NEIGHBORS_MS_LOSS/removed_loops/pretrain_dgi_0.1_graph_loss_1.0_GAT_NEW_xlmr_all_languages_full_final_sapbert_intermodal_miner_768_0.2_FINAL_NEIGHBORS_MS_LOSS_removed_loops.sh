...
#SBATCH --error=/home/etutubalina/graph_entity_linking/graphmel/logs/pretrain_graph_models_final/pretrain_dgi_0.1_graph_loss_1.0_GAT_NEW_xlmr_all_languages_full_final_sapbert_intermodal_miner_768_0.2_FINAL_NEIGHBORS_MS_LOSS_removed_loops.err        # Файл для вывода ошибок
#SBATCH --output=/home/etutubalina/graph_entity_linking/graphmel/logs/pretrain_graph_models_final/pretrain_dgi_0.1_graph_loss_1.0_GAT_NEW_xlmr_all_languages_full_final_sapbert_intermodal_miner_768_0.2_FINAL_NEIGHBORS_MS_LOSS_removed_loops.txt       # Файл для вывода результатов
