...
#SBATCH --error=/home/etutubalina/graph_entity_linking/graphmel/logs/pretrain_graph_models_final/pretrain_nodgi_graph_loss_0.1_GAT_NEW_xlmr_all_languages_full_final_sapbert_intermodal_miner_768_0.2_FINAL_NO_N_MS_noloops_cross_fused.err        # Файл для вывода ошибок
#SBATCH --output=/home/etutubalina/graph_entity_linking/graphmel/logs/pretrain_graph_models_final/pretrain_nodgi_graph_loss_0.1_GAT_NEW_xlmr_all_languages_full_final_sapbert_intermodal_miner_768_0.2_FINAL_NO_N_MS_noloops_cross_fused.txt       # Файл для вывода результатов
