...
#SBATCH --error=/home/etutubalina/graph_entity_linking/graphmel/logs/pretrain_graph_models_final/THIS_pretrain_TEXT_ONLY_mSAPBERT_all_FINAL_NO_N_MS_noloops_b128_MONOLINGUAL.err        # Файл для вывода ошибок
#SBATCH --output=/home/etutubalina/graph_entity_linking/graphmel/logs/pretrain_graph_models_final/THIS_pretrain_TEXT_ONLY_mSAPBERT_all_FINAL_NO_N_MS_noloops_b128_MONOLINGUAL.txt       # Файл для вывода результатов
