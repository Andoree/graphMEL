...
#SBATCH --error=/home/etutubalina/graph_entity_linking/graphmel/logs/pretrain_graph_models_final/pretrain_dgi_1.0_graph_loss_1.0_GAT_NEW_xlmr_all_INT_MINER_768_0.2_FINAL_NO_N_MS_noloops_b128_mapped_eng_20_20_20.err        # Файл для вывода ошибок
#SBATCH --output=/home/etutubalina/graph_entity_linking/graphmel/logs/pretrain_graph_models_final/pretrain_dgi_1.0_graph_loss_1.0_GAT_NEW_xlmr_all_INT_MINER_768_0.2_FINAL_NO_N_MS_noloops_b128_mapped_eng_20_20_20.txt       # Файл для вывода результатов
