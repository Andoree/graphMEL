...
#SBATCH --error=/home/etutubalina/graph_entity_linking/graphmel/logs/pretrain_graph_models_final/xlmr_dgi_0.01_graph_loss_0.1_all_languages_pretrain_graphsage_xlmr_sapbert_intermodal_nominer_768.err        # Файл для вывода ошибок
#SBATCH --output=/home/etutubalina/graph_entity_linking/graphmel/logs/pretrain_graph_models_final/xlmr_dgi_0.01_graph_loss_0.1_all_languages_pretrain_graphsage_xlmr_sapbert_intermodal_nominer_768.txt       # Файл для вывода результатов
...
--output_dir="/home/etutubalina/graph_entity_linking/results/pretrained_graphsapbert/2020AB/FINAL_MODELS/GRAPHSAGE_DGI_0.0_MULTILINGUAL"
