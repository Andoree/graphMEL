...
#SBATCH --error=/home/etutubalina/graph_entity_linking/graphmel/logs/pretrain_graph_models_final/pretrain_dgi_0.01_graph_loss_GAT_NEW_xlmr_all_languages_full_final_sapbert_WEIGHTED_intermodal_HARD_miner_768_0.2_DETACH_TXT.err        # Файл для вывода ошибок
#SBATCH --output=/home/etutubalina/graph_entity_linking/graphmel/logs/pretrain_graph_models_final/pretrain_dgi_0.01_graph_loss_GAT_NEW_xlmr_all_languages_full_final_sapbert_WEIGHTED_intermodal_HARD_miner_768_0.2_DETACH_TXT.txt       # Файл для вывода результатов
