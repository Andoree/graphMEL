...
#SBATCH --error=/home/etutubalina/graph_entity_linking/graphmel/logs/pretrain_graph_models_final/pretrain_dgi_graph_loss_graphsage_pubmedbert_english_full_sapbert_0.1_dgi_0.0_nominer_768.err        # Файл для вывода ошибок
#SBATCH --output=/home/etutubalina/graph_entity_linking/graphmel/logs/pretrain_graph_models_final/pretrain_dgi_graph_loss_graphsage_pubmedbert_english_full_sapbert_0.1_dgi_0.0_nominer_768.txt       # Файл для вывода результатов
...
--output_dir="/home/etutubalina/graph_entity_linking/results/pretrained_graphsapbert/2020AB/FINAL_MODELS/ENGLISH_GRAPHSAGE_FULL_PUBMEDBERT_NOMINER"
