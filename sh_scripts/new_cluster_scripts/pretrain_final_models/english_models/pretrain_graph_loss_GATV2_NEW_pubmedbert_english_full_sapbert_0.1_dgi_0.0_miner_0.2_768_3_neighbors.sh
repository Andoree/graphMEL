...
#SBATCH --error=/home/etutubalina/graph_entity_linking/graphmel/logs/pretrain_graph_models_final/pretrain_graph_loss_GATV2_NEW_pubmedbert_english_full_sapbert_0.1_dgi_0.0_miner_0.2_768_3_neighbors.err        # Файл для вывода ошибок
#SBATCH --output=/home/etutubalina/graph_entity_linking/graphmel/logs/pretrain_graph_models_final/pretrain_graph_loss_GATV2_NEW_pubmedbert_english_full_sapbert_0.1_dgi_0.0_miner_0.2_768_3_neighbors.txt       # Файл для вывода результатов
...
--output_dir="/home/etutubalina/graph_entity_linking/results/pretrained_graphsapbert/2020AB/FINAL_MODELS/ENGLISH_GATV2_FULL_PUBMEDBERT_MINER_0.2"
