...
#SBATCH --error=/home/echernyak/graph_entity_linking/graphmel/logs/pretrain_graph_models_final/pretrain_dgi_0.0_GRAPH_LOSS_ONLY_graphsage_sapbert_checkpoint_all_languages_full_final_sapbert_intermodal_nominer_768.err        # Файл для вывода ошибок
#SBATCH --output=/home/echernyak/graph_entity_linking/graphmel/logs/pretrain_graph_models_final/pretrain_dgi_0.0_GRAPH_LOSS_ONLY_graphsage_sapbert_checkpoint_all_languages_full_final_sapbert_intermodal_nominer_768.txt       # Файл для вывода результатов
...
--output_dir="/home/echernyak/graph_entity_linking/results/pretrained_graphsapbert/2020AB/FINAL_MODELS/GRAPH_LOSS_ONLY/GRAPHSAGE_DGI_0.0_MULTILINGUAL_SAPBERT_CHECKPOINT"
