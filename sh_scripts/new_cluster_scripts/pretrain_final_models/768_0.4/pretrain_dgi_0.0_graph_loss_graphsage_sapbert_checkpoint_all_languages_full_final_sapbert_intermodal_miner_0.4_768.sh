...
#SBATCH --error=/home/etutubalina/graph_entity_linking/graphmel/logs/pretrain_graph_models_final/xlmr_dgi_0.0_graph_loss_0.1_all_languages_pretrain_graphsage_sapbert_checkpoint_sapbert_intermodal_miner_0.4_768.err        # Файл для вывода ошибок
#SBATCH --output=/home/etutubalina/graph_entity_linking/graphmel/logs/pretrain_graph_models_final/xlmr_dgi_0.0_graph_loss_0.1_all_languages_pretrain_graphsage_sapbert_checkpoint_sapbert_intermodal_miner_0.4_768.txt       # Файл для вывода результатов
...
--output_dir="/home/etutubalina/graph_entity_linking/results/pretrained_graphsapbert/2020AB/FINAL_MODELS_MINER_0.4/GRAPHSAGE_DGI_0.0_MULTILINGUAL_ALL_LANGUAGES_SAPBERT_CHECKPOINT"
