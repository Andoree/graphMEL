...
#SBATCH --error=/home/echernyak/graph_entity_linking/graphmel/logs/pretrain_graph_models_final/pretrain_dgi_0.0_graph_loss_GAT_xlmr_all_languages_full_final_sapbert_intermodal_miner_0.4_768.err        # Файл для вывода ошибок
#SBATCH --output=/home/echernyak/graph_entity_linking/graphmel/logs/pretrain_graph_models_final/pretrain_dgi_0.0_graph_loss_GAT_xlmr_all_languages_full_final_sapbert_intermodal_miner_0.4_768.txt       # Файл для вывода результатов
