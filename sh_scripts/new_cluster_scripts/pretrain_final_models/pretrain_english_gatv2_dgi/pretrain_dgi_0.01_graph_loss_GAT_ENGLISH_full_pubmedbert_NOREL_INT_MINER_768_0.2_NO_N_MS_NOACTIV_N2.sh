...
#SBATCH --error=/home/etutubalina/graph_entity_linking/graphmel/logs/pretrain_graph_models_final/pretrain_dgi_0.01_graph_loss_GAT_ENGLISH_full_pubmedbert_NOREL_INT_MINER_768_0.2_NO_N_MS_NOACTIV_N2.err        # Файл для вывода ошибок
#SBATCH --output=/home/etutubalina/graph_entity_linking/graphmel/logs/pretrain_graph_models_final/pretrain_dgi_0.01_graph_loss_GAT_ENGLISH_full_pubmedbert_NOREL_INT_MINER_768_0.2_NO_N_MS_NOACTIV_N2.txt       # Файл для вывода результатов
