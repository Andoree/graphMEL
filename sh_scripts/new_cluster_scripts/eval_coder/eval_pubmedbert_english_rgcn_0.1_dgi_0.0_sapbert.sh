...
#SBATCH --error=/home/echernyak/graph_entity_linking/CODER/test/eval_results/pubmedbert_english_rgcn_0.1_dgi_0.0/sapbert_0.1.err        # Файл для вывода ошибок
#SBATCH --output=/home/echernyak/graph_entity_linking/CODER/test/eval_results/pubmedbert_english_rgcn_0.1_dgi_0.0/sapbert_0.1.txt       # Файл для вывода результатов
