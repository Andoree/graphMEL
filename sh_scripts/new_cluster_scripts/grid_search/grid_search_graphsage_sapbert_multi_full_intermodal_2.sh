...
#SBATCH --error=/home/etutubalina/graph_entity_linking/graphmel/logs/grid_search/grid_search_multi_full_graphsage_sapbert_intermodal_2.err        # Файл для вывода ошибок
#SBATCH --output=/home/etutubalina/graph_entity_linking/graphmel/logs/grid_search/grid_search_multi_full_graphsage_sapbert_intermodal_2.txt       # Файл для вывода результатов
