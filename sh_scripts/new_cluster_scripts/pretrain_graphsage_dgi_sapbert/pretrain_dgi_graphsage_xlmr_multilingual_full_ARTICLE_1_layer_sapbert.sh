...
#SBATCH --error=/home/etutubalina/graph_entity_linking/graphmel/logs/pretrain_graphsage_dgi_multilingual_full/xlmr_multilingual_pretrain_graphsage_xlmr_article_1_layer_sapbert.err        # Файл для вывода ошибок
#SBATCH --output=/home/etutubalina/graph_entity_linking/graphmel/logs/pretrain_graphsage_dgi_multilingual_full/xlmr_multilingual_pretrain_graphsage_xlmr_article_1_layer_sapbert.txt       # Файл для вывода результатов
