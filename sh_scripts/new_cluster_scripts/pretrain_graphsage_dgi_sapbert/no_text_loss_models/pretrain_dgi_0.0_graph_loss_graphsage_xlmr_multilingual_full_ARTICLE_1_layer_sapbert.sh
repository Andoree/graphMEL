...
#SBATCH --error=/home/etutubalina/graph_entity_linking/graphmel/logs/pretrain_graphsage_dgi_multilingual_full/no_text_loss_dgi_0.0_graph_loss_multilingual_pretrain_graphsage_xlmr_article_1_layer_sapbert.err        # Файл для вывода ошибок
#SBATCH --output=/home/etutubalina/graph_entity_linking/graphmel/logs/pretrain_graphsage_dgi_multilingual_full/no_text_loss_dgi_0.0_graph_loss_multilingual_pretrain_graphsage_xlmr_article_1_layer_sapbert.txt       # Файл для вывода результатов
...
--output_dir="/home/etutubalina/graph_entity_linking/results/pretrained_graphsapbert/2020AB/DGI_GRAPH_LOSS_GraphSAGE/MULTILINGUAL_FULL_XLMR_NO_TEXT_LOSS"
