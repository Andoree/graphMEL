...
#SBATCH --error=/home/etutubalina/graph_entity_linking/graphmel/logs/pretrain_graphsage_dgi_multilingual_full/no_text_loss_dgi_0.0_graph_loss_multilingual_pretrain_graphsage_sapbert_checkpoint_article_1_layer_cosine.err        # Файл для вывода ошибок
#SBATCH --output=/home/etutubalina/graph_entity_linking/graphmel/logs/pretrain_graphsage_dgi_multilingual_full/no_text_loss_dgi_0.0_graph_loss_multilingual_pretrain_graphsage_sapbert_checkpoint_article_1_layer_cosine.txt       # Файл для вывода результатов
