...
#SBATCH --error=/home/echernyak/graph_entity_linking/graphmel/logs/pretrain_graphsage_dgi_multilingual_full/mbert_multilingual_pretrain_graphsage_mbert_article_1_layer_cosine.err        # Файл для вывода ошибок
#SBATCH --output=/home/echernyak/graph_entity_linking/graphmel/logs/pretrain_graphsage_dgi_multilingual_full/mbert_multilingual_pretrain_graphsage_mbert_article_1_layer_cosine.txt       # Файл для вывода результатов
