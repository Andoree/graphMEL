...
#SBATCH --error=/home/etutubalina/graph_entity_linking/graphmel/logs/pretrain_monolingual_graphsage_graph_0.1_dgi_0.0/MONOLINGUAL_pretrain_graphsage_xlmr_article_1_layer_sapbert_0.1.err        # Файл для вывода ошибок
#SBATCH --output=/home/etutubalina/graph_entity_linking/graphmel/logs/pretrain_monolingual_graphsage_graph_0.1_dgi_0.0/MONOLINGUAL_pretrain_graphsage_xlmr_article_1_layer_sapbert_0.1.txt       # Файл для вывода результатов
