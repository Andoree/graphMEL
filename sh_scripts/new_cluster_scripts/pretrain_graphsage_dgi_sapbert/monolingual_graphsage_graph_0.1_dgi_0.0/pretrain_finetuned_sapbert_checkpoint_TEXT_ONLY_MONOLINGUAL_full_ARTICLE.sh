...
--output_dir="/home/echernyak/graph_entity_linking/results/TEXT_ONLY_MODELS/SPA_FULL_SAPBERT_CHECKPOINT"
...
--agg_mode "cls" \
--save_every_N_epoch=1 \
--output_dir="/home/echernyak/graph_entity_linking/results/TEXT_ONLY_MODELS/DUT_FULL_SAPBERT_CHECKPOINT"
...
--agg_mode "cls" \
--save_every_N_epoch=1 \
--output_dir="/home/echernyak/graph_entity_linking/results/TEXT_ONLY_MODELS/FRE_FULL_SAPBERT_CHECKPOINT"
...
--agg_mode "cls" \
--save_every_N_epoch=1 \
--output_dir="/home/echernyak/graph_entity_linking/results/TEXT_ONLY_MODELS/GER_FULL_SAPBERT_CHECKPOINT"
