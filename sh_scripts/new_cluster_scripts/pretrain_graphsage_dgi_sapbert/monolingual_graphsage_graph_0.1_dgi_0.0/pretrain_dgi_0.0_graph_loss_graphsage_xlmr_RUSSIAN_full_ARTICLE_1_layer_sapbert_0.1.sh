...
#SBATCH --error=/home/etutubalina/graph_entity_linking/graphmel/logs/pretrain_RUSSIAN_graphsage_graph_0.1_dgi_0.0/RUSSIAN_pretrain_graphsage_xlmr_article_1_layer_sapbert_0.1.err        # Файл для вывода ошибок
#SBATCH --output=/home/etutubalina/graph_entity_linking/graphmel/logs/pretrain_RUSSIAN_graphsage_graph_0.1_dgi_0.0/RUSSIAN_pretrain_graphsage_xlmr_article_1_layer_sapbert_0.1.txt       # Файл для вывода результатов
...
--output_dir="/home/etutubalina/graph_entity_linking/results/pretrained_graphsapbert/2020AB/DGI_GRAPH_LOSS_GraphSAGE/RUS_FULL_XLMR"
