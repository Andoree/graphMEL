...
#SBATCH --error=/home/echernyak/graph_entity_linking/graphmel/logs/pretrain_graphsage_dgi_multilingual_full/xlmr_multilingual_pretrain_graphsage_xlmr_article_1_layer_not_intermodal.err        # Файл для вывода ошибок
#SBATCH --output=/home/echernyak/graph_entity_linking/graphmel/logs/pretrain_graphsage_dgi_multilingual_full/xlmr_multilingual_pretrain_graphsage_xlmr_article_1_layer_not_intermodal.txt       # Файл для вывода результатов
...
--output_dir="/home/echernyak/graph_entity_linking/results/pretrained_graphsapbert/2020AB/DGI_GraphSAGE/MULTILINGUAL_FULL_XLMR"
