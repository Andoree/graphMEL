...
#SBATCH --error=/home/etutubalina/graph_entity_linking/graphmel/logs/pretrain_graphsage_dgi_multilingual_full/pubmedbert_english_checkpoint_dgi_graph_loss_pretrain_graphsage_sapbert_checkpoint_article_1_layer_cosine_0.1_dgi_0.0.err        # Файл для вывода ошибок
#SBATCH --output=/home/etutubalina/graph_entity_linking/graphmel/logs/pretrain_graphsage_dgi_multilingual_full/pubmedbert_english_checkpoint_dgi_graph_loss_pretrain_graphsage_sapbert_checkpoint_article_1_layer_cosine_0.1_dgi_0.0.txt       # Файл для вывода результатов
