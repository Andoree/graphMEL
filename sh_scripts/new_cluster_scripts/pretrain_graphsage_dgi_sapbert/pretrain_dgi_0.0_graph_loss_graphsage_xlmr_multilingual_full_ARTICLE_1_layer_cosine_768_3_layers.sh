...
#SBATCH --error=/home/echernyak/graph_entity_linking/graphmel/logs/pretrain_graphsage_dgi_multilingual_full/xlmr_dgi_graph_loss_multilingual_pretrain_graphsage_xlmr_article_1_layer_cosine_768_3_layers.err        # Файл для вывода ошибок
#SBATCH --output=/home/echernyak/graph_entity_linking/graphmel/logs/pretrain_graphsage_dgi_multilingual_full/xlmr_dgi_graph_loss_multilingual_pretrain_graphsage_xlmr_article_1_layer_cosine_768_3_layers.txt       # Файл для вывода результатов
...
--output_dir="/home/echernyak/graph_entity_linking/results/pretrained_graphsapbert/2020AB/DGI_GRAPH_LOSS_GraphSAGE/MULTILINGUAL_FULL_XLMR_768"
