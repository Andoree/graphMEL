...
#SBATCH --error=/home/etutubalina/graph_entity_linking/graphmel/logs/pretrain_graphsage_dgi_multilingual_full/xlmr_dgi_graph_loss_multilingual_pretrain_graphsage_xlmr_article_1_layer_sapbert_intermodal_miner_0.4.err        # Файл для вывода ошибок
#SBATCH --output=/home/etutubalina/graph_entity_linking/graphmel/logs/pretrain_graphsage_dgi_multilingual_full/xlmr_dgi_graph_loss_multilingual_pretrain_graphsage_xlmr_article_1_layer_sapbert_intermodal_miner_0.4.txt       # Файл для вывода результатов
