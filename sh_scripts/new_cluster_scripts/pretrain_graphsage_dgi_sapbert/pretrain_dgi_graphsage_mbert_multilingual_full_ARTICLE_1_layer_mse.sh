...
#SBATCH --error=/home/etutubalina/graph_entity_linking/graphmel/logs/pretrain_graphsage_dgi_multilingual_full/mbert_multilingual_pretrain_graphsage_mbert_article_1_layer_mse.err        # Файл для вывода ошибок
#SBATCH --output=/home/etutubalina/graph_entity_linking/graphmel/logs/pretrain_graphsage_dgi_multilingual_full/mbert_multilingual_pretrain_graphsage_mbert_article_1_layer_mse.txt       # Файл для вывода результатов
