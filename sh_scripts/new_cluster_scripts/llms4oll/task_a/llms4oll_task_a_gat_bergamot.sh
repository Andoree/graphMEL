...
#SBATCH --error=/home/etutubalina/graph_entity_linking/graphmel/logs/llms4oll/task_a/llms4oll_task_a_gat_bergamot.err        # Файл для вывода ошибок
#SBATCH --output=/home/etutubalina/graph_entity_linking/graphmel/logs/llms4oll/task_a/llms4oll_task_a_gat_bergamot.txt       # Файл для вывода результатов
...
models=("/home/etutubalina/graph_entity_linking/huggingface_models/BERGAMOT/GAT-mBERGAMOT/")
