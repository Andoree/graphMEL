...
#SBATCH --error=/home/etutubalina/graph_entity_linking/graphmel/logs/llms4oll/task_a/llms4oll_task_a_msapbert.err        # Файл для вывода ошибок
#SBATCH --output=/home/etutubalina/graph_entity_linking/graphmel/logs/llms4oll/task_a/llms4oll_task_a_msapbert.txt       # Файл для вывода результатов
...
models=("/home/etutubalina/graph_entity_linking/huggingface_models/cambridgeltl/SapBERT-UMLS-2020AB-all-lang-from-XLMR/")
