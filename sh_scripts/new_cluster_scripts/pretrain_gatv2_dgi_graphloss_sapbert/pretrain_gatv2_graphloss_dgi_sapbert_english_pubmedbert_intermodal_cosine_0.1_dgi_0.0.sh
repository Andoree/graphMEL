...
#SBATCH --error=/home/etutubalina/graph_entity_linking/graphmel/logs/pretrain_gatv2_dgi_multilingual_full/pretrain_gatv2_graphloss_dgi_sapbert_english_pubmedbert_intermodal_cosine_0.1_dgi_0.0.err        # Файл для вывода ошибок
#SBATCH --output=/home/etutubalina/graph_entity_linking/graphmel/logs/pretrain_gatv2_dgi_multilingual_full/pretrain_gatv2_graphloss_dgi_sapbert_english_pubmedbert_intermodal_cosine_0.1_dgi_0.0.txt       # Файл для вывода результатов
