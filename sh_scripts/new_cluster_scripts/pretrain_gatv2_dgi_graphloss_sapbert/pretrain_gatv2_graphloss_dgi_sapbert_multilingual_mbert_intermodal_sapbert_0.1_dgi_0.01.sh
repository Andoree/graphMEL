...
#SBATCH --error=/home/echernyak/graph_entity_linking/graphmel/logs/pretrain_gatv2_dgi_multilingual_full/mbert_dgi_graph_loss_multilingual_pretrain_gatv2_mbert_article_1_layer_sapbert_0.1_dgi_0.01.err        # Файл для вывода ошибок
#SBATCH --output=/home/echernyak/graph_entity_linking/graphmel/logs/pretrain_gatv2_dgi_multilingual_full/mbert_dgi_graph_loss_multilingual_pretrain_gatv2_mbert_article_1_layer_sapbert_0.1_dgi_0.01.txt       # Файл для вывода результатов
...
--output_dir="/home/echernyak/graph_entity_linking/results/pretrained_graphsapbert/2020AB/DGI_GRAPH_LOSS_GatV2/MULTILINGUAL_FULL_MBERT"
