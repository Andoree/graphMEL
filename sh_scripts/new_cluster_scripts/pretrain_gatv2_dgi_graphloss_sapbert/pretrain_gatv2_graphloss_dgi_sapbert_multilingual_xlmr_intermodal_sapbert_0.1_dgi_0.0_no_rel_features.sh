...
#SBATCH --error=/home/etutubalina/graph_entity_linking/graphmel/logs/pretrain_gatv2_dgi_multilingual_full/xlmr_dgi_graph_loss_multilingual_pretrain_gatv2_xlmr_article_1_layer_sapbert_0.1_dgi_0.0_no_rel_features.err        # Файл для вывода ошибок
#SBATCH --output=/home/etutubalina/graph_entity_linking/graphmel/logs/pretrain_gatv2_dgi_multilingual_full/xlmr_dgi_graph_loss_multilingual_pretrain_gatv2_xlmr_article_1_layer_sapbert_0.1_dgi_0.0_no_rel_features.txt       # Файл для вывода результатов
...
--output_dir="/home/etutubalina/graph_entity_linking/results/pretrained_graphsapbert/2020AB/DGI_GRAPH_LOSS_GatV2/MULTILINGUAL_FULL_XLMR_NO_REL_FEATURES"
