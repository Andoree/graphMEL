...
#SBATCH --error=/home/etutubalina/graph_entity_linking/graphmel/logs/biosyn_train/biosyn_medical_crossing_cometa_stratified_GAT_DGI_0.0_NO_LOOPS_NOREL_INT_MINER_0.2_ACTIV_SEP_HP.err        # Файл для вывода ошибок
#SBATCH --output=/home/etutubalina/graph_entity_linking/graphmel/logs/biosyn_train/biosyn_medical_crossing_cometa_stratified_GAT_DGI_0.0_NO_LOOPS_NOREL_INT_MINER_0.2_ACTIV_SEP_HP.txt       # Файл для вывода результатов
