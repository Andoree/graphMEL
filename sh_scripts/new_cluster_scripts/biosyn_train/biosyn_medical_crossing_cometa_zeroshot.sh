...
#SBATCH --error=/home/etutubalina/graph_entity_linking/graphmel/logs/biosyn_train/biosyn_medical_crossing_cometa_zeroshot.err        # Файл для вывода ошибок
#SBATCH --output=/home/etutubalina/graph_entity_linking/graphmel/logs/biosyn_train/biosyn_medical_crossing_cometa_zeroshot.txt       # Файл для вывода результатов
...
COMETA_ZEROSHOT_TRAIN_DICT="/home/etutubalina/graph_entity_linking/fair_eval_coling_datasets/cometa_zeroshot/COMETA_id_sf_dictionary.txt"
COMETA_ZEROSHOT_TRAIN_DIR="/home/etutubalina/graph_entity_linking/fair_eval_coling_datasets/cometa_zeroshot/train/"



echo "Training EnSapBERT..."
echo "Training EnSapBERT..." 1>&2
mkdir -p "/home/etutubalina/graph_entity_linking/results/trained_biosyn_models/ensapbert/cometa_zeroshot/"
...
--train_dictionary_path $COMETA_ZEROSHOT_TRAIN_DICT \
--train_dir $COMETA_ZEROSHOT_TRAIN_DIR \
--output_dir "/home/etutubalina/graph_entity_linking/results/trained_biosyn_models/ensapbert/cometa_zeroshot/" \
--use_cuda \
--topk 20 \
--epoch 20 \
--train_batch_size 16 \
...
mkdir -p "/home/etutubalina/graph_entity_linking/results/trained_biosyn_models/encoder/cometa_zeroshot/"
python /home/etutubalina/graph_entity_linking/BioSyn/train.py \
--model_name_or_path "/home/etutubalina/graph_entity_linking/huggingface_models/GanjinZero/coder_eng/" \
--train_dictionary_path $COMETA_ZEROSHOT_TRAIN_DICT \
--train_dir $COMETA_ZEROSHOT_TRAIN_DIR \
--output_dir "/home/etutubalina/graph_entity_linking/results/trained_biosyn_models/encoder/cometa_zeroshot/" \
--use_cuda \
--topk 20 \
--epoch 20 \
--train_batch_size 16 \
...
mkdir -p "/home/etutubalina/graph_entity_linking/results/trained_biosyn_models/GAT_DGI_0.0_NO_LOOPS_NOREL_INT_MINER_0.2_ACTIV_SEP_HP/cometa_zeroshot/"
python /home/etutubalina/graph_entity_linking/BioSyn/train.py \
...
--train_dictionary_path $COMETA_ZEROSHOT_TRAIN_DICT \
--train_dir $COMETA_ZEROSHOT_TRAIN_DIR \
--output_dir "/home/etutubalina/graph_entity_linking/results/trained_biosyn_models/GAT_DGI_0.0_NO_LOOPS_NOREL_INT_MINER_0.2_ACTIV_SEP_HP/cometa_zeroshot/" \
--use_cuda \
--topk 20 \
--epoch 20 \
--train_batch_size 16 \
