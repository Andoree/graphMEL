...
#SBATCH --error=/home/etutubalina/graph_entity_linking/graphmel/logs/biosyn_train/train_biosyn_encoder.err        # Файл для вывода ошибок
#SBATCH --output=/home/etutubalina/graph_entity_linking/graphmel/logs/biosyn_train/train_biosyn_encoder.txt       # Файл для вывода результатов
...
mkdir -p "/home/etutubalina/graph_entity_linking/results/trained_biosyn_models/encoder/NCBI/"
...
--output_dir "/home/etutubalina/graph_entity_linking/results/trained_biosyn_models/encoder/NCBI/" \
--use_cuda \
--topk 20 \
--epoch 20 \
--train_batch_size 16 \
...
mkdir -p "/home/etutubalina/graph_entity_linking/results/trained_biosyn_models/encoder/BC5CDRD/"
python /home/etutubalina/graph_entity_linking/BioSyn/train.py \
--model_name_or_path $MODEL \
--train_dictionary_path $BC5CDRD_TRAIN_DICT \
--train_dir $BC5CDRD_TRAIN_DIR \
--output_dir "/home/etutubalina/graph_entity_linking/results/trained_biosyn_models/encoder/BC5CDRD/" \
--use_cuda \
--topk 20 \
--epoch 20 \
--train_batch_size 16 \
...
mkdir -p "/home/etutubalina/graph_entity_linking/results/trained_biosyn_models/encoder/BC5CDRC/"
python /home/etutubalina/graph_entity_linking/BioSyn/train.py \
--model_name_or_path $MODEL \
--train_dictionary_path $BC5CDRC_TRAIN_DICT \
--train_dir $BC5CDRC_TRAIN_DIR \
--output_dir "/home/etutubalina/graph_entity_linking/results/trained_biosyn_models/encoder/BC5CDRC/" \
--use_cuda \
--topk 20 \
--epoch 20 \
--train_batch_size 16 \
...
mkdir -p "/home/etutubalina/graph_entity_linking/results/trained_biosyn_models/encoder/BC2GN/"
python /home/etutubalina/graph_entity_linking/BioSyn/train.py \
--model_name_or_path $MODEL \
--train_dictionary_path $BC2GN_TRAIN_DICT \
--train_dir $BC2GN_TRAIN_DIR \
--output_dir "/home/etutubalina/graph_entity_linking/results/trained_biosyn_models/encoder/BC2GN/" \
--use_cuda \
--topk 20 \
--epoch 20 \
--train_batch_size 16 \
...
mkdir -p "/home/etutubalina/graph_entity_linking/results/trained_biosyn_models/encoder/SMM4H/"
python /home/etutubalina/graph_entity_linking/BioSyn/train.py \
--model_name_or_path $MODEL \
--train_dictionary_path $SMM4H_TRAIN_DICT \
--train_dir $SMM4H_TRAIN_DIR \
--output_dir "/home/etutubalina/graph_entity_linking/results/trained_biosyn_models/encoder/SMM4H/" \
--use_cuda \
--topk 20 \
--epoch 20 \
--train_batch_size 16 \
