...
#SBATCH --error=/home/etutubalina/graph_entity_linking/graphmel/logs/biosyn_train/train_biosyn_engebert_graphsage_neighbors_loss_3_dgi_0.01_b128_NO_N_MS_SMM4H.err        # Файл для вывода ошибок
#SBATCH --output=/home/etutubalina/graph_entity_linking/graphmel/logs/biosyn_train/train_biosyn_engebert_graphsage_neighbors_loss_3_dgi_0.01_b128_NO_N_MS_SMM4H.txt       # Файл для вывода результатов
