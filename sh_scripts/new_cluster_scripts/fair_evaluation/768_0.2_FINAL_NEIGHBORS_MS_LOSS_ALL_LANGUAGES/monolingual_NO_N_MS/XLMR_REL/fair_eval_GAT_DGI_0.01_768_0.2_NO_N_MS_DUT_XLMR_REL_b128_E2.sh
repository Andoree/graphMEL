...
#SBATCH --error=/home/etutubalina/graph_entity_linking/graphmel/logs/fair_evaluation/fair_eval_GAT_DGI_0.01_768_0.2_NO_N_MS_DUT_XLMR_REL_b128_E2.err        # Файл для вывода ошибок
#SBATCH --output=/home/etutubalina/graph_entity_linking/graphmel/logs/fair_evaluation/fair_eval_GAT_DGI_0.01_768_0.2_NO_N_MS_DUT_XLMR_REL_b128_E2.txt       # Файл для вывода результатов
