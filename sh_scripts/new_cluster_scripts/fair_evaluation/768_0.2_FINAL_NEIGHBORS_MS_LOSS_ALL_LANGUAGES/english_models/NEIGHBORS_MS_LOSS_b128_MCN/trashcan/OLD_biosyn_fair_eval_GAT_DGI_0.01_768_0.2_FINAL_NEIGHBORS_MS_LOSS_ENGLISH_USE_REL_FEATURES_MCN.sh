...
#SBATCH --error=/home/etutubalina/graph_entity_linking/graphmel/logs/fair_evaluation/biosyn_fair_eval_GAT_DGI_0.01_768_0.2_FINAL_NEIGHBORS_MS_LOSS_ENGLISH_USE_REL_FEATURES_MCN.err        # Файл для вывода ошибок
#SBATCH --output=/home/etutubalina/graph_entity_linking/graphmel/logs/fair_evaluation/biosyn_fair_eval_GAT_DGI_0.01_768_0.2_FINAL_NEIGHBORS_MS_LOSS_ENGLISH_USE_REL_FEATURES_MCN.txt       # Файл для вывода результатов
#SBATCH --time=08:30:00                      # Максимальное время выполнения
...
python /home/etutubalina/graph_entity_linking/BioSyn/eval.py --model_name_or_path ${MODEL} \
