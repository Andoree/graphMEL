...
#SBATCH --error=/home/etutubalina/graph_entity_linking/graphmel/logs/fair_evaluation/fair_eval_TEXT_ONLY_768_0.2_NEIGHBORS_MS_LOSS_DUT_SAPBERT_CKPT_b128_E2.err        # Файл для вывода ошибок
#SBATCH --output=/home/etutubalina/graph_entity_linking/graphmel/logs/fair_evaluation/fair_eval_TEXT_ONLY_768_0.2_NEIGHBORS_MS_LOSS_DUT_SAPBERT_CKPT_b128_E2.txt       # Файл для вывода результатов
