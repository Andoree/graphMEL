...
#SBATCH --error=/home/echernyak/graph_entity_linking/graphmel/logs/fair_evaluation/fair_eval_graphsage_sapbert_intermodal_layer_2_cosine.err        # Файл для вывода ошибок
#SBATCH --output=/home/echernyak/graph_entity_linking/graphmel/logs/fair_evaluation/fair_eval_graphsage_sapbert_intermodal_layer_2_cosine.txt       # Файл для вывода результатов
#SBATCH --time=20:30:00                      # Максимальное время выполнения
#SBATCH --cpus-per-task=3                   # Количество CPU на одну задачу
#SBATCH --gpus=1

export CUDA_VISIBLE_DEVICES=0
MODEL="/home/echernyak/graph_entity_linking/results/pretrained_encoders/2020AB/GraphSAGE/MULTILINGUAL_FULL/gs_2-256_2text_loss_1.0_graph_loss_1.0_intermodal_cosine_1.0_remove_loops_True_2.2_0.3_lr_2e-05_b_128/checkpoint_e_1_steps_159510.pth/"
