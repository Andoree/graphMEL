...
#SBATCH --error=/home/etutubalina/graph_entity_linking/graphmel/logs/fair_evaluation/fair_eval_RGCN_DGI_0.0_768_0.2_FINAL_FREEZE_ALL_LANGUAGES_XLMR_b256.err        # Файл для вывода ошибок
#SBATCH --output=/home/etutubalina/graph_entity_linking/graphmel/logs/fair_evaluation/fair_eval_RGCN_DGI_0.0_768_0.2_FINAL_FREEZE_ALL_LANGUAGES_XLMR_b256.txt       # Файл для вывода результатов
