...
#SBATCH --error=/home/etutubalina/graph_entity_linking/graphmel/logs/fair_evaluation/fair_eval_dgi_graphsage_sapxlmr_intermodal_layer_1_sapbert_loss_0.1.err        # Файл для вывода ошибок
#SBATCH --output=/home/etutubalina/graph_entity_linking/graphmel/logs/fair_evaluation/fair_eval_dgi_graphsage_sapxlmr_intermodal_layer_1_sapbert_loss_0.1.txt       # Файл для вывода результатов
...
MODEL="/home/etutubalina/graph_entity_linking/results/pretrained_encoders/2020AB/DGI_GraphSAGE/MULTILINGUAL_FULL_XLMR/gs_1-3_text_loss_1.0_256_3_0.3_remove_loops_True_dgi_0.1modal_sapbert_0.1_lr_2e-05_b_128/checkpoint_e_1_steps_159510.pth/"
