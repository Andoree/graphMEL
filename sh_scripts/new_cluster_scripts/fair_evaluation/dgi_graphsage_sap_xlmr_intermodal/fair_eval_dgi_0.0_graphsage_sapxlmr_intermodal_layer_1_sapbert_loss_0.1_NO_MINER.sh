...
#SBATCH --error=/home/echernyak/graph_entity_linking/graphmel/logs/fair_evaluation/fair_eval_dgi_0.0_graphsage_sapxlmr_intermodal_layer_1_sapbert_loss_0.1_NO_MINER.err        # Файл для вывода ошибок
#SBATCH --output=/home/echernyak/graph_entity_linking/graphmel/logs/fair_evaluation/fair_eval_dgi_0.0_graphsage_sapxlmr_intermodal_layer_1_sapbert_loss_0.1_NO_MINER.txt       # Файл для вывода результатов
...
MODEL="/home/echernyak/graph_entity_linking/results/pretrained_encoders/2020AB/GraphSAGE_DGI_GRAPH_LOSS/MULTILINGUAL_FULL_XLMR_NO_MINER/gs_1-3_text_loss_1.0_256_3_0.3_remove_loops_True_graph_0.1_dgi_0.0_modal_sapbert_0.1_intermodal_miner_False_lr_2e-05_b_128/checkpoint_e_1_steps_159510.pth/"
