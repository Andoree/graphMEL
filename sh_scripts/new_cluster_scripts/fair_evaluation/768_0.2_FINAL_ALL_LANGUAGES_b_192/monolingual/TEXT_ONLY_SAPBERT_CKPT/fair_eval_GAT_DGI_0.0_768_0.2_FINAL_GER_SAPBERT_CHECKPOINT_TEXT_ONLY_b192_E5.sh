...
#SBATCH --error=/home/etutubalina/graph_entity_linking/graphmel/logs/fair_evaluation/fair_eval_GAT_DGI_0.0_768_0.2_FINAL_GER_SAPBERT_CHECKPOINT_TEXT_ONLY_b192_E5.err        # Файл для вывода ошибок
#SBATCH --output=/home/etutubalina/graph_entity_linking/graphmel/logs/fair_evaluation/fair_eval_GAT_DGI_0.0_768_0.2_FINAL_GER_SAPBERT_CHECKPOINT_TEXT_ONLY_b192_E5.txt       # Файл для вывода результатов
