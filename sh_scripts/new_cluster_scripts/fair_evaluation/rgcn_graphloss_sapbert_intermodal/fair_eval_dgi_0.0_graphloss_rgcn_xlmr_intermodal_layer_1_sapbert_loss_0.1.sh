...
#SBATCH --error=/home/echernyak/graph_entity_linking/graphmel/logs/fair_evaluation/fair_eval_dgi_0.0_graphloss_rgcn_xlmr_intermodal_layer_1_sapbert_loss_0.1.err        # Файл для вывода ошибок
#SBATCH --output=/home/echernyak/graph_entity_linking/graphmel/logs/fair_evaluation/fair_eval_dgi_0.0_graphloss_rgcn_xlmr_intermodal_layer_1_sapbert_loss_0.1.txt       # Файл для вывода результатов
