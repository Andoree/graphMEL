...
#SBATCH --error=/home/etutubalina/graph_entity_linking/graphmel/logs/fair_evaluation/fair_eval_dgi_0.0_graphloss_rgcn_xlmr_intermodal_layer_1_sapbert_loss_0.1.err        # Файл для вывода ошибок
#SBATCH --output=/home/etutubalina/graph_entity_linking/graphmel/logs/fair_evaluation/fair_eval_dgi_0.0_graphloss_rgcn_xlmr_intermodal_layer_1_sapbert_loss_0.1.txt       # Файл для вывода результатов
...
MODEL="/home/etutubalina/graph_entity_linking/results/pretrained_encoders/2020AB/RGCN_DGI_GRAPH_LOSS/MULTILINGUAL_FULL_XLMR/dgi_0.0_rgcn_1_3_[3]_text_1.0_remove_loops_Truegraph_loss_0.1_intermodal_sapbert_0.1_0.3_256--None-64_rel_intermodal_miner_True_lr_2e-05_b_128_fast_rgcn_conv/checkpoint_e_1_steps_159510.pth"
