...
#SBATCH --error=/home/echernyak/graph_entity_linking/graphmel/logs/fair_evaluation/fair_eval_dgi_0.01_graphloss_gatv2_mbert_intermodal_layer_1_sapbert_loss_0.1.err        # Файл для вывода ошибок
#SBATCH --output=/home/echernyak/graph_entity_linking/graphmel/logs/fair_evaluation/fair_eval_dgi_0.01_graphloss_gatv2_mbert_intermodal_layer_1_sapbert_loss_0.1.txt       # Файл для вывода результатов
...
MODEL="/home/echernyak/graph_entity_linking/results/pretrained_encoders/2020AB/GATV2_DGI_GRAPH_LOSS/MULTILINGUAL_FULL_MBERT/gatv2_3_256_1_3_0.3_2_0.1_graph_loss_0.1_rel_remove_loops_True_dgi_0.01_text_loss_1.0_intermodal_sapbert_0.1_lr_2e-05_b_128/checkpoint_e_1_steps_159510.pth"
