...
#SBATCH --error=/home/echernyak/graph_entity_linking/graphmel/logs/fair_evaluation/sapbert_baseline.err        # Файл для вывода ошибок
#SBATCH --output=/home/echernyak/graph_entity_linking/graphmel/logs/fair_evaluation/sapbert_baseline.txt       # Файл для вывода результатов
...
MODEL="/home/echernyak/graph_entity_linking/huggingface_models/cambridgeltl/SapBERT-UMLS-2020AB-all-lang-from-XLMR/"
