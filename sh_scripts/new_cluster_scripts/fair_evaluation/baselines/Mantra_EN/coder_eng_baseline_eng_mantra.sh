...
#SBATCH --error=/home/etutubalina/graph_entity_linking/graphmel/logs/fair_evaluation/coder_eng_baseline_eng_mantra.err        # Файл для вывода ошибок
#SBATCH --output=/home/etutubalina/graph_entity_linking/graphmel/logs/fair_evaluation/coder_eng_baseline_eng_mantra.txt       # Файл для вывода результатов
