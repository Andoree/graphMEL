...
#SBATCH --error=/home/etutubalina/graph_entity_linking/graphmel/logs/fair_evaluation/mul_sapbert_baseline_v2_en_mantra.err        # Файл для вывода ошибок
#SBATCH --output=/home/etutubalina/graph_entity_linking/graphmel/logs/fair_evaluation/mul_sapbert_baseline_v2_en_mantra.txt       # Файл для вывода результатов
