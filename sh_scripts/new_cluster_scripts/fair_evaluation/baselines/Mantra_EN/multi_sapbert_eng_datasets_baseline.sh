...
#SBATCH --error=/home/etutubalina/graph_entity_linking/graphmel/logs/fair_evaluation/multi_sapbert_eng_datasets_baseline.err        # Файл для вывода ошибок
#SBATCH --output=/home/etutubalina/graph_entity_linking/graphmel/logs/fair_evaluation/multi_sapbert_eng_datasets_baseline.txt       # Файл для вывода результатов
