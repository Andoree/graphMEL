...
#SBATCH --error=/home/etutubalina/graph_entity_linking/graphmel/logs/fair_evaluation/fair_eval_GATV2_768_0.2_NO_ACTIVATION_FIXED_HARD_PAIRS_WEIGHTED_SOFT_DGI_0.01_NOREL.err        # Файл для вывода ошибок
#SBATCH --output=/home/etutubalina/graph_entity_linking/graphmel/logs/fair_evaluation/fair_eval_GATV2_768_0.2_NO_ACTIVATION_FIXED_HARD_PAIRS_WEIGHTED_SOFT_DGI_0.01_NOREL.txt       # Файл для вывода результатов
#SBATCH --time=03:30:00                      # Максимальное время выполнения
#SBATCH --cpus-per-task=3                   # Количество CPU на одну задачу
#SBATCH --gpus=1

export CUDA_VISIBLE_DEVICES=0
MODEL="/home/etutubalina/graph_entity_linking/results/pretrained_encoders/2020AB/768_0.2_WEIGHTED_INTERMODAL_ALL_LANGUAGES/GAT_DGI_WEIGHTED_INTERMODAL_MULTILINGUAL_NOACTIV/gatv2_3_768_1_1_0.3_2_0.0_graph_loss_0.1_rel_NEW_rl_True_dgi_0.01_tl_1.0_inter_sapbert_intermodal_miner_False_0.2_rel_feat_False_freeze_neigh_False_tl_neighbors_False_ilt_cosine_istrat_soft_det_txt_False_0.1_lr_2e-05_b_128_NO_ACTIV/checkpoint_e_1_steps_172907.pth/"
