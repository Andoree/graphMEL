...
#SBATCH --error=/home/etutubalina/graph_entity_linking/graphmel/logs/fair_evaluation/fair_eval_GATV2_768_0.2_INTERMODAL_HARD_NODETACH_DGI_0.0_v2.err        # Файл для вывода ошибок
#SBATCH --output=/home/etutubalina/graph_entity_linking/graphmel/logs/fair_evaluation/fair_eval_GATV2_768_0.2_INTERMODAL_HARD_NODETACH_DGI_0.0_v2.txt       # Файл для вывода результатов
#SBATCH --time=03:30:00                      # Максимальное время выполнения
#SBATCH --cpus-per-task=3                   # Количество CPU на одну задачу
#SBATCH --gpus=1

export CUDA_VISIBLE_DEVICES=0
MODEL="/home/etutubalina/graph_entity_linking/results/pretrained_encoders/2020AB/768_0.2_WEIGHTED_INTERMODAL_ALL_LANGUAGES/GAT_DGI_WEIGHTED_INTERMODAL_MULTILINGUAL/gatv2_3_768_1_3_0.3_2_0.1_graph_loss_0.1_rel_NEW_rl_False_dgi_0.0_tl_1.0_inter_sapbert_intermodal_miner_False_0.2_relational_features_True_freeze_neigh_False_tl_neighbors_False_ilt_cosine_istrat_hard_det_txt_False_0.1_lr_2e-05_b_128/checkpoint_e_1_steps_172907.pth/"
