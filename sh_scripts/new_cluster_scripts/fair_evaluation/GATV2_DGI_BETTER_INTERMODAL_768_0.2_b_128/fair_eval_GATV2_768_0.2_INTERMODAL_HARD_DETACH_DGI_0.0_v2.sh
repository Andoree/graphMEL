...
#SBATCH --error=/home/etutubalina/graph_entity_linking/graphmel/logs/fair_evaluation/fair_eval_GATV2_768_0.2_INTERMODAL_HARD_DETACH_DGI_0.0_v2.err        # Файл для вывода ошибок
#SBATCH --output=/home/etutubalina/graph_entity_linking/graphmel/logs/fair_evaluation/fair_eval_GATV2_768_0.2_INTERMODAL_HARD_DETACH_DGI_0.0_v2.txt       # Файл для вывода результатов
