...
#SBATCH --error=/home/etutubalina/graph_entity_linking/graphmel/logs/fair_evaluation/zeroshot_medical_crossing_refined_cometa_stratified.err        # Файл для вывода ошибок
#SBATCH --output=/home/etutubalina/graph_entity_linking/graphmel/logs/fair_evaluation/zeroshot_medical_crossing_refined_cometa_stratified.txt       # Файл для вывода результатов
...
DICT_PATH="/home/etutubalina/graph_entity_linking/fair_eval_coling_datasets/cometa_stratified/COMETA_id_sf_dictionary.txt"
DATA_DIR="/home/etutubalina/graph_entity_linking/fair_eval_coling_datasets/cometa_stratified/processed_test_refined/"


MODEL="/home/etutubalina/graph_entity_linking/huggingface_models/cambridgeltl/SapBERT-from-PubMedBERT-fulltext/"
echo "stratified cometa sapbert refined"
...
echo "stratified cometa coder refined"
python /home/etutubalina/graph_entity_linking/Fair-Evaluation-BERT/eval_bert_ranking.py --model_dir $MODEL \
    --data_folder $DATA_DIR \
    --vocab $DICT_PATH
...
echo "stratified cometa graphsage_DGI_0.0_INTERMODAL_MINER_0.2_REMOVED_LOOPS_NO_N_MS refined"
python /home/etutubalina/graph_entity_linking/Fair-Evaluation-BERT/eval_bert_ranking.py --model_dir $MODEL \
    --data_folder $DATA_DIR \
    --vocab $DICT_PATH
...
echo "stratified cometa GAT_DGI_0.0_NO_LOOPS_NOREL_INT_MINER_0.2_ACTIV_SEP_HP refined"
python /home/etutubalina/graph_entity_linking/Fair-Evaluation-BERT/eval_bert_ranking.py --model_dir $MODEL \
    --data_folder $DATA_DIR \
    --vocab $DICT_PATH
