...
#SBATCH --error=/home/etutubalina/graph_entity_linking/graphmel/logs/fair_evaluation/zeroshot_medical_crossing_gat_neighbors_loss_3_dgi_0.01_b128_NO_N_MS_NOREL.err        # Файл для вывода ошибок
#SBATCH --output=/home/etutubalina/graph_entity_linking/graphmel/logs/fair_evaluation/zeroshot_medical_crossing_gat_neighbors_loss_3_dgi_0.01_b128_NO_N_MS_NOREL.txt       # Файл для вывода результатов
