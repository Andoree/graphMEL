...
#SBATCH --error=/home/etutubalina/graph_entity_linking/graphmel/logs/fair_evaluation/wilcoxon_fair_eval_GAT_mBERGAMOT_QUAERO_MEDLINE.err        # Файл для вывода ошибок
#SBATCH --output=/home/etutubalina/graph_entity_linking/graphmel/logs/fair_evaluation/wilcoxon_fair_eval_GAT_mBERGAMOT_QUAERO_MEDLINE.txt       # Файл для вывода результатов
