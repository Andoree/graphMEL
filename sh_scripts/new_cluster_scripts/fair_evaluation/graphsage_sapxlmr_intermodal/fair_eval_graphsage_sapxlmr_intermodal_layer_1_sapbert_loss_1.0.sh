...
#SBATCH --error=/home/etutubalina/graph_entity_linking/graphmel/logs/fair_evaluation/fair_eval_graphsage_sapxlmr_intermodal_layer_1_sapbert_loss_1.0.err        # Файл для вывода ошибок
#SBATCH --output=/home/etutubalina/graph_entity_linking/graphmel/logs/fair_evaluation/fair_eval_graphsage_sapxlmr_intermodal_layer_1_sapbert_loss_1.0.txt       # Файл для вывода результатов
...
MODEL="/home/etutubalina/graph_entity_linking/results/pretrained_encoders/2020AB/GraphSAGE/MULTILINGUAL_FULL_XLMR/gs_1-256_3text_loss_1.0_graph_loss_1.0_intermodal_sapbert_1.0_remove_loops_True_3_0.3_lr_2e-05_b_128/checkpoint_e_1_steps_159510.pth/"
