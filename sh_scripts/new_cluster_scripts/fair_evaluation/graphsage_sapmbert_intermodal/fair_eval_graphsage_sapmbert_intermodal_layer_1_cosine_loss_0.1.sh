...
#SBATCH --error=/home/etutubalina/graph_entity_linking/graphmel/logs/fair_evaluation/fair_eval_graphsage_sapmbert_intermodal_layer_1_cosine_loss_0.1.err        # Файл для вывода ошибок
#SBATCH --output=/home/etutubalina/graph_entity_linking/graphmel/logs/fair_evaluation/fair_eval_graphsage_sapmbert_intermodal_layer_1_cosine_loss_0.1.txt       # Файл для вывода результатов
