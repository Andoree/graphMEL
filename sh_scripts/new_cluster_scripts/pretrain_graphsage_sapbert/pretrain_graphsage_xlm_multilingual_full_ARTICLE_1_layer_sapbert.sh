...
#SBATCH --error=/home/etutubalina/graph_entity_linking/graphmel/logs/pretrain_graphsage_sapbert_multilingual_full/multilingual_pretrain_graphsage_xlm_article_1_layer_sapbert.err        # Файл для вывода ошибок
#SBATCH --output=/home/etutubalina/graph_entity_linking/graphmel/logs/pretrain_graphsage_sapbert_multilingual_full/multilingual_pretrain_graphsage_xlm_article_1_layer_sapbert.txt       # Файл для вывода результатов
...
--output_dir="/home/etutubalina/graph_entity_linking/results/pretrained_graphsapbert/2020AB/GraphSAGE/MULTILINGUAL_FULL_XLM"
