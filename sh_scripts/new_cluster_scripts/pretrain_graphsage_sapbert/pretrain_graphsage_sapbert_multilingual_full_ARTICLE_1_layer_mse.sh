...
#SBATCH --error=/home/echernyak/graph_entity_linking/graphmel/logs/pretrain_graphsage_sapbert_multilingual_full/multilingual_pretrain_graphsage_sapbert_article_1_layer_mse.err        # Файл для вывода ошибок
#SBATCH --output=/home/echernyak/graph_entity_linking/graphmel/logs/pretrain_graphsage_sapbert_multilingual_full/multilingual_pretrain_graphsage_sapbert_article_1_layer_mse.txt       # Файл для вывода результатов
