...
#SBATCH --error=/home/etutubalina/graph_entity_linking/graphmel/logs/pretrain_hake_sapbert/ru_full_pretrain_hake_sapbert_gamma_10.err        # Файл для вывода ошибок
#SBATCH --output=/home/etutubalina/graph_entity_linking/graphmel/logs/pretrain_hake_sapbert/ru_full_pretrain_hake_sapbert_gamma_10.txt       # Файл для вывода результатов
