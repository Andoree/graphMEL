...
#SBATCH --error=/home/echernyak/graph_entity_linking/graphmel/logs/pretrain_hake_sapbert/ru_full_pretrain_hake_sapbert_gamma_0.1.err        # Файл для вывода ошибок
#SBATCH --output=/home/echernyak/graph_entity_linking/graphmel/logs/pretrain_hake_sapbert/ru_full_pretrain_hake_sapbert_gamma_0.1.txt       # Файл для вывода результатов
