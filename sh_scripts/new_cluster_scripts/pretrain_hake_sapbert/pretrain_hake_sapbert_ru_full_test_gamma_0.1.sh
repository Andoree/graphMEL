...
#SBATCH --error=/home/etutubalina/graph_entity_linking/graphmel/logs/pretrain_hake_sapbert/ru_full_pretrain_hake_sapbert_gamma_0.1.err        # Файл для вывода ошибок
#SBATCH --output=/home/etutubalina/graph_entity_linking/graphmel/logs/pretrain_hake_sapbert/ru_full_pretrain_hake_sapbert_gamma_0.1.txt       # Файл для вывода результатов
...
--output_dir="/home/etutubalina/graph_entity_linking/results/pretrained_graphsapbert/2020AB/HAKE_SAPBERT/RU_FULL_TEST_MBERT"
