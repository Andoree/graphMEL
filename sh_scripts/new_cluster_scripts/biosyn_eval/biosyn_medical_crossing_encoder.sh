...
#SBATCH --error=/home/etutubalina/graph_entity_linking/graphmel/logs/biosyn_eval/eval_biosyn_encoder.err        # Файл для вывода ошибок
#SBATCH --output=/home/etutubalina/graph_entity_linking/graphmel/logs/biosyn_eval/eval_biosyn_encoder.txt       # Файл для вывода результатов
...
mkdir -p "/home/etutubalina/graph_entity_linking/results/evaluation_biosyn_models/encoder/NCBI/full_test"
mkdir -p "/home/etutubalina/graph_entity_linking/results/evaluation_biosyn_models/encoder/NCBI/refined_test"
python /home/etutubalina/graph_entity_linking/BioSyn/eval.py \
    --model_name_or_path "/home/etutubalina/graph_entity_linking/results/trained_biosyn_models/encoder/NCBI/" \
    --dictionary_path $NCBID_TEST_DICT \
    --data_dir $NCBID_TEST_DIR \
    --output_dir "/home/etutubalina/graph_entity_linking/results/evaluation_biosyn_models/encoder/NCBI/full_test" \
    --use_cuda \
    --topk 20 \
    --max_length 25 \
    --save_predictions
...
python /home/etutubalina/graph_entity_linking/BioSyn/eval.py \
    ...
    --output_dir "/home/etutubalina/graph_entity_linking/results/evaluation_biosyn_models/encoder/NCBI/refined_test" \
    --use_cuda \
    --topk 20 \
    --max_length 25 \
    --save_predictions
...
mkdir -p "/home/etutubalina/graph_entity_linking/results/evaluation_biosyn_models/encoder/BC5CDRD/full_test"
mkdir -p "/home/etutubalina/graph_entity_linking/results/evaluation_biosyn_models/encoder/BC5CDRD/refined_test"
python /home/etutubalina/graph_entity_linking/BioSyn/eval.py \
    --model_name_or_path "/home/etutubalina/graph_entity_linking/results/trained_biosyn_models/encoder/BC5CDRD/" \
    --dictionary_path $BC5CDRD_TEST_DICT \
    --data_dir $BC5CDRD_TEST_DIR \
    --output_dir "/home/etutubalina/graph_entity_linking/results/evaluation_biosyn_models/encoder/BC5CDRD/" \
    --use_cuda \
    --topk 20 \
    --max_length 25 \
    --save_predictions
...
mkdir -p "/home/etutubalina/graph_entity_linking/results/evaluation_biosyn_models/encoder/BC5CDRC/full_test"
mkdir -p "/home/etutubalina/graph_entity_linking/results/evaluation_biosyn_models/encoder/BC5CDRC/refined_test"
python /home/etutubalina/graph_entity_linking/BioSyn/eval.py \
    --model_name_or_path "/home/etutubalina/graph_entity_linking/results/trained_biosyn_models/encoder/BC5CDRC/" \
    --dictionary_path $BC5CDRC_TEST_DICT \
    --data_dir $BC5CDRC_TEST_DIR \
    --output_dir "/home/etutubalina/graph_entity_linking/results/evaluation_biosyn_models/encoder/BC5CDRC/" \
    --use_cuda \
    --topk 20 \
    --max_length 25 \
    --save_predictions
...
mkdir -p "/home/etutubalina/graph_entity_linking/results/evaluation_biosyn_models/encoder/BC2GN/full_test"
mkdir -p "/home/etutubalina/graph_entity_linking/results/evaluation_biosyn_models/encoder/BC2GN/refined_test"
python /home/etutubalina/graph_entity_linking/BioSyn/eval.py \
    --model_name_or_path "/home/etutubalina/graph_entity_linking/results/trained_biosyn_models/encoder/BC2GN/" \
    --dictionary_path $BC2GN_TEST_DICT \
    --data_dir $BC2GN_TEST_DIR \
    --output_dir "/home/etutubalina/graph_entity_linking/results/evaluation_biosyn_models/encoder/BC2GN/" \
    --use_cuda \
    --topk 20 \
    --max_length 25 \
    --save_predictions
...
mkdir -p "/home/etutubalina/graph_entity_linking/results/evaluation_biosyn_models/encoder/SMM4H/full_test"
mkdir -p "/home/etutubalina/graph_entity_linking/results/evaluation_biosyn_models/encoder/SMM4H/refined_test"
python /home/etutubalina/graph_entity_linking/BioSyn/eval.py \
    --model_name_or_path "/home/etutubalina/graph_entity_linking/results/trained_biosyn_models/encoder/SMM4H/" \
    --dictionary_path $SMM4H_TEST_DICT \
    --data_dir $SMM4H_TEST_DIR \
    --output_dir "/home/etutubalina/graph_entity_linking/results/evaluation_biosyn_models/encoder/SMM4H/" \
    --use_cuda \
    --topk 20 \
    --max_length 25 \
    --save_predictions
