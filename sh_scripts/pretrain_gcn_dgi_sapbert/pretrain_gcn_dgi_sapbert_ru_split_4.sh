...
#SBATCH --error=../../logs/pretrain_gcn_dgi_sapbert_ru_split/ru_pretrain_gcn_dgi_sapbert_4.err        # Файл для вывода ошибок
#SBATCH --output=../../logs/pretrain_gcn_dgi_sapbert_ru_split/ru_pretrain_gcn_dgi_sapbert_4.txt       # Файл для вывода результатов
