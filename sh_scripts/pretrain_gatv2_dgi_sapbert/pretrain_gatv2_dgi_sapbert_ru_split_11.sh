...
#SBATCH --error=../../logs/pretrain_gat_dgi_sapbert_ru_split/ru_pretrain_gat_dgi_sapbert_11.err        # Файл для вывода ошибок
#SBATCH --output=../../logs/pretrain_gat_dgi_sapbert_ru_split/ru_pretrain_gat_dgi_sapbert_11.txt       # Файл для вывода результатов
