...
#SBATCH --error=../../logs/pretrain_hake_sapbert/ru_split_pretrain_hake_sapbert_4.err        # Файл для вывода ошибок
#SBATCH --output=../../logs/pretrain_hake_sapbert/ru_split_pretrain_hake_sapbert_4.txt       # Файл для вывода результатов
