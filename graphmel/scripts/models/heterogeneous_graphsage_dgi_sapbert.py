...
class HeteroGraphSageDgiSapMetricLearning(nn.Module, AbstractGraphSapMetricLearningModel):
    ...
    def forward(self, text_embed_1, text_embed_2, concept_ids, pos_graph_embed_1, pos_graph_embed_2,
        ...
        sapbert_loss, _ = self.calculate_sapbert_loss(text_embed_1[:batch_size], text_embed_2[:batch_size],
                                                   labels[:batch_size])

        graph_loss, _ = self.calculate_sapbert_loss(pos_graph_embed_1[:batch_size], pos_graph_embed_2[:batch_size],
                                                 labels[:batch_size])
