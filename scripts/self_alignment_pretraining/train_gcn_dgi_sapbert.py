...
from graphmel.scripts.self_alignment_pretraining.graph_sapbert_models import GCNDGISapMetricLearning
    ...
    if amp:
        with autocast():
            loss = model(term_1_input_ids=term_1_input_ids, term_1_att_masks=term_1_att_masks,
                         ...
                         concept_ids=concept_ids, edge_index=edge_index, batch_size=batch_size)
    else:
        loss = model(term_1_input_ids=term_1_input_ids, term_1_att_masks=term_1_att_masks,
                     term_2_input_ids=term_2_input_ids, term_2_att_masks=term_2_att_masks,
                     concept_ids=concept_ids, edge_index=edge_index, batch_size=batch_size)
...
def main(args):
    ...
    train_pos_pair_sampler = PositivePairNeighborSampler(pos_pairs_term_1_id_list=train_pos_pairs_term_1_id_list,
                                                         ...
                                                         sizes=args.gcn_num_neighbors, edge_index=edge_index,
