...
class RGCNLinkPredictorOverBert(nn.Module):
    ...
    def forward(self, pos_src_input_ids, pos_src_attention_mask, pos_src_adjs, pos_src_rel_ids,
        ...
        pos_x_uninverted = self.apply_convs(x=pos_src_cls_embeddings, edge_index=pos_src_adjs,
                                            rel_type=pos_src_rel_ids)[:batch_size]
        # print("pos_x_uninverted", pos_x_uninverted.size())
        # print("pos_x_uninverted", pos_x_uninverted.size())
        pos_x_inv = self.apply_convs(x=pos_trg_cls_embeddings, edge_index=pos_trg_adjs,
                                     rel_type=pos_trg_rel_ids)[:batch_size]
        # print("pos_x_inv", pos_x_inv.size())
        # print("pos_x_inv", pos_x_inv.size())
        neg_x_uninverted = self.apply_convs(x=neg_src_cls_embeddings, edge_index=neg_src_adjs,
                                            rel_type=neg_src_rel_ids)[:batch_size]
        # print("neg_x_uninverted", neg_x_uninverted.size())
        # print("neg_x_uninverted", neg_x_uninverted.size())

        neg_x_inv = self.apply_convs(x=neg_trg_cls_embeddings, edge_index=neg_trg_adjs,
                                     rel_type=neg_trg_rel_ids)[:batch_size]
        # print("neg_x_inv", neg_x_inv.size())
        # print("neg_x_inv", neg_x_inv.size())
